...
<script src="scripts/highcharts/highcharts_exporting.js"></script>
<script type="text/javascript" src="assets/js/control.js"></script>
    <!-- End of Highcharts Scripts -->
    <style>
    ...
    <?php /*?><link href='https://api.mapbox.com/mapbox.js/v2.2.3/mapbox.css' rel='stylesheet' />

    <link rel="stylesheet" href="http://cdn.leafletjs.com/leaflet/v0.7.7/leaflet.css">
    <link rel="stylesheet" href="assets/css/leaflet_awesome_markers.css"><?php */?>
    <!--this is new-->
   ...
   <style type="text/css">
    ...
    <?php
	$dbClass = '';
	/* $_SESSION['sess_lanet_account']['us_role'] = 1; $_SESSION['RoleId'] = 1;
