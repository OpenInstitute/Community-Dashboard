...
<form name="frm_serviceregister" id="frm_serviceregister" class="rwdvalid" method="post" action="_posts.php">
	...
	<div class="top form-group">
		...
		<div class="col-md-9">
		<input type="text" class="form-control required" name="name" id="name" placeholder="Please enter your name/ group name" />
		</div>
	</div>
	...
	<div class="top form-group">
		...
		<div class="col-md-9">
		<input type="text" class="form-control required" name="cell" id="cell" placeholder="Please enter your mobile number" />
		</div>
	</div>
	<div class="clearfix"></div>
	<div class="top form-group">
