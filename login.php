        ...
        <center><img class="brand-img" src="assets/images/logo.png" alt="..."></center>
            ...
            <div class="content-box border-top border-blue clearfix">
                <div class="content-box-wrapper row">
                    ...
                    <form action="inc/control.php"  class="col-md-7" method="post">
                        <div id="login-form">
                            <div class="pad20A">
                                ...
                                <div style="margin: 2px 1px"><?php echo $error; ?></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <p><a href="register.php">No Account? Sign up</a> | <a href="forgot-password.php">Forgot Password? </a></p>
                                </div>
