<?php
$Nocq = mysqli_query($conn, "SELECT * FROM `sr_serviceregister` WHERE published=1");
            ...
            <div class="tile-content-wrapper">
                ...
                <div class="tile-content">
                    <?php
                        ...
                        $schedQ = mysqli_query($conn, "SELECT * FROM `sr_followup` WHERE week(`followup_date`) = week(DATE_ADD(NOW(), INTERVAL 1 WEEK))");
            ...
            <div class="tile-content-wrapper">
                ...
                <div class="tile-content">
                    <?php
                        ...
                        $schedmQ = mysqli_query($conn, "SELECT * FROM `sr_followup` WHERE month(`followup_date`) = month(DATE_ADD(NOW(), INTERVAL 1 MONTH))");
  ...
  <div class="col-md-4 bReport" name="umoja">
    <div class="tile-box tile-box-alt bg-blue-alt">
        ...
        <div class="tile-content-wrapper">
            ...
            <div class="tile-content">
               <?php 
              $sbQ = $cndb->dbQuery("SELECT * FROM `sr_serviceregister` WHERE location = 'Umoja'");
      ...
      <div class="col-md-4 bReport" name="murunyu">
        <div class="tile-box tile-box-alt bg-blue-alt">
            ...
            <div class="tile-content-wrapper">
                ...
                <div class="tile-content">
                   <?php 
              $sbQ = $cndb->dbQuery("SELECT * FROM `sr_serviceregister` WHERE location = 'Murunyu'");
              echo $cndb->recordCount($sbQ)." Cases";
               ?>
                </div>
                <small>
      ...
      <div class="col-md-4 bReport" name="kiamunyeki">
        <div class="tile-box tile-box-alt bg-blue-alt">
            ...
            <div class="tile-content-wrapper">
                ...
                <div class="tile-content">
                   <?php 
              $sbQ = $cndb->dbQuery("SELECT * FROM `sr_serviceregister` WHERE location = 'Kiamunyeki'");
              echo $cndb->recordCount($sbQ)." Cases";
               ?>
                </div>
                <small>
